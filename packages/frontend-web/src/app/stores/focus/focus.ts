...
export const unfocusedElement = createAction<void>('root/UNFOCUSED_ELEMENT');
export const saveFocus = createAction<void>('root/SAVE_FOCUS');
export const restoreFocus = createAction<void>('root/RESTORE_FOCUS');
